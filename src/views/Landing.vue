<template>
  <div id="home" class="bg-gray-50">
    ...
    <div class="flex mt-32 px-6 lg:px-32 space-x-28">
      ...
      <div class="w-full lg:w-1/2 ">
        ...
        <p class="mt-8 font-body font-medium text-gray-900 text-2xl tracking-widest"> Full Stack Web Developer, Digital Marketing  Expert & Entrepreneur</p>

            <!-- The social Media section -->

          <div class="flex space-x-8 mt-12">
        <a href=""> <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-facebook h-6 w-6"  viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
